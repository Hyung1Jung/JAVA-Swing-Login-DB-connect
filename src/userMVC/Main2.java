...
class Main2 extends JFrame implements ActionListener {
	...
	public Main2() {
		...
		String id2 = tf.getText();
		String pw2 = tf2.getText();
		...
		Id.setBounds(385, 300, 250, 200);
		tf.setBounds(510, 380, 160, 35);
		pw.setBounds(385, 350, 250, 200);
		tf2.setBounds(510, 435, 160, 35);
